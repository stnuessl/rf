...
```
    python fix-jcdb.py -p -f /path/to/compile_commands.json -- -I/usr/lib/clang/$(llvm-config --version)/include
```
...
```
    python fix-jcdb.py -r -p -f /path/to/compile_commands.json -- -pedantic -Wno-maybe-initialized
```
